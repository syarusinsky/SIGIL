...
class SurfaceTest : public Surface<640, 480, CP_FORMAT::RGB_24BIT, NUM_THREADS, false, SHADER_PASS_DATA_SIZE>
{
	public:
		SurfaceTest();
		~SurfaceTest();
		...
		void draw(GRAPHICS<640, 480, CP_FORMAT::RGB_24BIT, false, SHADER_PASS_DATA_SIZE>* graphics) override;
