...
Sprite<CP_FORMAT::RGBA_32BIT, CURRENT_RENDER_API>*      test_sprite_ptr = nullptr;

char         test_texture1[TEXTURE_FILE_SIZE];
Texture<CP_FORMAT::RGBA_32BIT, CURRENT_RENDER_API>*     test_texture1_ptr = nullptr;

char         test_texture2[TEXTURE_FILE_SIZE];
Texture<CP_FORMAT::RGBA_32BIT, CURRENT_RENDER_API>*     test_texture2_ptr = nullptr;
...
void initStuff()
{
	...
	test_sprite_ptr = new Sprite<CP_FORMAT::RGBA_32BIT, CURRENT_RENDER_API>( (uint8_t*)test_sprite );;
	...
	test_texture1_ptr = new Texture<CP_FORMAT::RGBA_32BIT, CURRENT_RENDER_API>( (uint8_t*)test_texture1 );
	test_texture2_ptr = new Texture<CP_FORMAT::RGBA_32BIT, CURRENT_RENDER_API>( (uint8_t*)test_texture2 );
}
